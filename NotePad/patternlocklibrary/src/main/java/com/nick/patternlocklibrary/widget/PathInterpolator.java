...
public class PathInterpolator implements Interpolator {
    ...
    private void initPath(Path path) {
        ...
        try {
            ...
            Log.e(PathInterpolator.class.getName(), "Error when invoke method. " + e.getLocalizedMessage());
        }

        float[] pointComponents = new float[0];

        if (obj != null) {
            try {
                pointComponents = (float[]) obj;
                Log.d(PathInterpolator.class.getName(), "Successfully assign value after hoo.");
