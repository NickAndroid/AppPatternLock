...
package dev.nick.apppatternlock.pattern;

import java.util.ArrayList;
import java.util.List;

import dev.nick.apppatternlock.R;
...
public class LockPatternView extends View {
	...
	public LockPatternView(Context context, AttributeSet attrs) {
		...
		mRegularColor = getResources().getColor(R.color.light_blue);
		mErrorColor = getResources().getColor(R.color.light_red);

		int pathColor = getResources().getColor(R.color.light_blue);
